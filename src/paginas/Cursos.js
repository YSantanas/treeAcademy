...
const Cursos = () => {
  return (
    <div
      ...
      style={{ minHeight: '100vh', paddingTop: '5vh', marginTop: '5vh' }}
    >
          ...
          <Col sm={5}>
            <Tab.Content>
              <Tab.Pane eventKey="#link1">
                Cursos relacionados con la carrera de Ingenieria
              </Tab.Pane>
              <Tab.Pane eventKey="#link2">
                Cursos relacionados con la carrera de Derecho
              </Tab.Pane>
              <Tab.Pane eventKey="#link3">
                Cursos relacionados con la carrera de Psicologia
              </Tab.Pane>
              <Tab.Pane eventKey="#link4">
                Cursos relacionados con la carrera de Quimica
              </Tab.Pane>
              <Tab.Pane eventKey="#link5">
                Cursos relacionados con la carrera de Odontologia
              </Tab.Pane>
              <Tab.Pane eventKey="#link6">
                Cursos relacionados con la carrera de Medicina
              </Tab.Pane>
            </Tab.Content>
          </Col>
        </Row>
